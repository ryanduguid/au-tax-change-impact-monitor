...
au-tax-change-impact-monitor compare \
  --baseline samples/baseline/sample-sources.json \
  --observation samples/observations/sample-register-observation.json \
  --map samples/mappings/sample-source-skill-map.json \
  --out build/demo
```
